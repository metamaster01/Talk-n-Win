  ...
  const handleEnroll = async () => {
    ...
    try {
      if (isFree) {
        ...
        if (!res.ok) {
          throw new Error(json.error || "Failed to enroll in demo class.");
        }

        setShowSuccess(true);
        setPaying(false);
      } else {
        // PAID DEMO – Razorpay flow
    ...
    <main className="min-h-screen bg-gradient-to-br from-fuchsia-50 via-white to-purple-50 pt-24 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-8">
          ...
          {/* ... keep your existing summary / benefits JSX here ... */}
          {/* I’ve omitted for brevity, but you can keep exactly what you had */}
